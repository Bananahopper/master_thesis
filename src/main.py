...
if __name__ == "__main__":
    ...
    parser.add_argument('--atlas_path', type=str, help='Path to the atlas')
    parser.add_argument('--save_path', type=str, help='Path to save the processed data')
    parser.add_argument('--array_size', type=str, help='Dimensions of the array')
    ...
    # Convert string representation of array_size to a list of integers
    if args.array_size:
        arg['array_size'] = [int(x) for x in args.array_size.split(',')]
